    ...
    <section class="text-gray-600 body-font">
        @if ($request_sent_successfully)
            <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
                <h1 class="title-font font-medium text-2xl text-gray-900">We have received your request! You will be
                    notified via email or text when your requested document is ready for pickup.</h1>
            </div>
        @else
            <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
                <div class="lg:w-3/5 md:w-1/2 md:pr-16 p-10">
                    <h1 class="title-font font-medium text-2xl text-gray-900">Click on the document you want to request
                        and
                        fill in the required fields.</h1>
                    <div class="grid grid-cols-1 mt-4 mr-7">
                        <a class="cursor-pointer border border-gray-500 p-2 rounded-md mt-5 font-bold @if ($form_name == 'Barangay Certification') bg-gray-700 text-white @endif"
                            wire:click="$set('form_name', 'Barangay Certification')">Barangay Certification</a>
                        <a class="cursor-pointer border border-gray-500 p-2 rounded-md mt-5 font-bold @if ($form_name == 'Barangay Clearance') bg-gray-700 text-white @endif"
                            wire:click="$set('form_name', 'Barangay Clearance')">Barangay Clearance</a>
                        <a class="cursor-pointer border border-gray-500 p-2 rounded-md mt-5 font-bold @if ($form_name == 'Case Invitation') bg-gray-700 text-white @endif"
                            wire:click="$set('form_name', 'Case Invitation')">Case Invitation</a>
                        <a class="cursor-pointer border border-gray-500 p-2 rounded-md mt-5 font-bold @if ($form_name == 'Certificate of Indigency') bg-gray-700 text-white @endif"
                ...
                <div
                    class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg flex flex-col md:ml-auto w-full mt-10 md:mt-0 p-10">
                    @if ($form_name == 'Barangay Certification')
                        <div>
                            <div>
                                ...
                                <div class="relative mb-4">
                                    <label for="years_of_residency" class="leading-7 text-sm text-gray-600">Number of
                                        years of
                                        residency</label>
                    ...
                    @if ($form_name == 'Certificate of Low Income')
                        <div>
                            <div>
                                <h2 class="text-gray-900 text-lg font-bold title-font mb-5">Certificate of Low Income
                                </h2>
                                <input type="hidden" wire:model="form_id">
                                <div class="relative mb-4">
                                    <label for="full-name" class="leading-7 text-sm text-gray-600">Resident
                    ...
                    @if ($form_name == 'Case Invitation')
                        <div>
                            <div>
                                ...
                                <input type="hidden" wire:model="form_id">
                                <div class="relative mb-4">
                                    <label for="full-name" class="leading-7 text-sm text-gray-600">Resident profile of
                                        main complainant</label>
                                    <input
                                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                                        placeholder="Search for the resident profile" type="text"
                                        wire:model="residentQuery" id="residentQuery" required />
                                ...
                                <div class="relative mb-4">
                                    <label for="complainants" class="leading-7 text-sm text-gray-600">Other
                                        complainant/s</label><br>
                                ...
                                <div class="relative mb-4">
                                    <label for="respondents"
                                        class="leading-7 text-sm text-gray-600">Respondent/s</label><br>
                                    <small>Separate with comma(,)</small>
                                    <input type="text" id="respondents" wire:model="respondents"
                                        class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                                <div class="relative mb-4">
                                    <label for="invitation-date"
                                        class="leading-7 text-sm text-gray-600">Date</label><br>
                    ...
                    @if ($form_name == 'Certificate of Indigency')
                        <div>
                            <div>
                                <h2 class="text-gray-900 text-lg font-bold title-font mb-5">Certificate of Indigency
                                </h2>
                                <input type="hidden" wire:model="form_id">
                                <div class="relative mb-4">
                                    <label for="full-name" class="leading-7 text-sm text-gray-600">Resident

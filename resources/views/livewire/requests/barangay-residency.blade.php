<h1 class="text-center font-bold mt-10 text-xl mb-10">BARANGAY RESIDENCY</h1>
<p class="mb-4">TO WHOM IT MAY CONCERN:</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that
    <u>{{ $request->resident->name }}</u>, <u>{{ $request->resident->age }}</u> years of age, was born on
    {{ date('F jS, Y', strtotime($form_fields->request_date_of_birth)) }} <u
        class="lowercase">{{ $request->resident->civil_status }}</u> and a bonafide resident of Barangay Paulino Labio,

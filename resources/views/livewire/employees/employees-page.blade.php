          ...
          <thead>
            <tr class="bg-blue-100 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
              ...
              <th class="px-4 py-3">
                <span class="flex flex-col">
                  Term start
                  <div class="flex flex-row">@include('livewire.includes.order-by', ["field" => 'term_start'])</div>
                </span>
              </th>
              <th class="px-4 py-3">
                <span class="flex flex-col">
                  Term end
                  <div class="flex flex-row">@include('livewire.includes.order-by', ["field" => 'term_end'])</div>
                </span>
              </th>

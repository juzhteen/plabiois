                    ...
                    <div class="w-full">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <label class="block text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-blue-400 focus:outline-none focus:shadow-outline-blue dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="johndoe@mail.com" name="email" value="{{ old('email') }}" required autofocus />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                <input type="checkbox" class="form-checkbox" name="remember"> <span class="ml-1 text-gray-700 dark:text-gray-400 font-bold">{{ __('Remember me') }}</span>
                            </label>

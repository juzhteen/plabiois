<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
      <div class="flex items-center justify-between h-full px-20 mx-auto text-purple-600 dark:text-purple-300">
          <!-- Mobile hamburger -->
          <button class="hamburger p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple" @click="toggleSideMenu" aria-label="Menu">

...
/* harmony import */ var qr_scanner__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! qr-scanner */ "./node_modules/qr-scanner/qr-scanner.min.js");
...
window.addEventListener("resident_updated", function (event) {
...
window.addEventListener("resident_added", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
...
window.addEventListener("employee_type_updated", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
...
window.addEventListener("employee_type_added", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
...
window.addEventListener("employee_type_deleted", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
...
window.addEventListener("employee_updated", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
...
window.addEventListener("employee_deleted", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
...
window.addEventListener("attendance_in", function (event) {
  node_snackbar__WEBPACK_IMPORTED_MODULE_2___default().show({
